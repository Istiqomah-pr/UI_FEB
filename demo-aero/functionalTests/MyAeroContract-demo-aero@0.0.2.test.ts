...
describe('MyAeroContract-demo-aero@0.0.2' , () => {
    ...
    describe('createMyAero', () => {
        it('should submit createMyAero transaction', async () => {
            // TODO: populate transaction parameters
            const myAeroId: string = '009';
            const value: string = 'Airbus A321';
            const args: string[] = [ myAeroId, value];
    ...
    describe('updateMyAero', () => {
        it('should submit updateMyAero transaction', async () => {
            ...
            const args: string[] = [ myAeroId, newValue];
